...
/**
 * Switch chain to provided chain id.
 */
...
/**
 * Add chain (Eth Goerli, Polygon Mumbai).
 */
export const addChain = async (chainId: string): Promise<void> => {
  switch (chainId) {
    case Chains.ETH_GOERLI: {
      await window.ethereum.request({
        method: 'wallet_addEthereumChain',
        params: [
          {
            chainId: Chains.ETH_GOERLI,
            chainName: 'Ethereum Goerli (Alchemy)',
            rpcUrls: ['https://eth-goerli.g.alchemy.com/v2/simulation-demo'],
          },
        ],
      });
      break;
        ...
        params: [
          {
            ...
            rpcUrls: [
              'https://polygon-mumbai.g.alchemy.com/v2/simulation-demo',
            ],
          },
        ],
      });
    ...
    default:
      throw new Error('Add a provider in MetaMask settings');
  }
};
...
export const swapNative = async () => {
  ...
  await sendTransaction({
    ...
    value: '0xDE0B6B3A7640000',
    data: '',
  });
};
